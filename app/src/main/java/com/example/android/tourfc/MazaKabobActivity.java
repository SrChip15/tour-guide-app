...
public class MazaKabobActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		detailImageView.setImageResource(R.drawable.maza_kabob);

		// grab a handle on the text view
		TextView textView = findViewById(R.id.detail_text_view);
		textView.setText(getString(R.string.maza_kabob_detailed_desc_card_text));
	}
	...
	public void showOnMap(View view) {
		...
		Uri location = Uri
				.parse("geo:0,0?q=40.5551019,-105.0802294(Maza+Kabob)");
