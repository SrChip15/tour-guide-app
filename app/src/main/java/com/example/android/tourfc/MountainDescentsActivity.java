...
public class MountainDescentsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		detailImageView.setImageResource(R.drawable.whitewater_rafting);

		// grab a handle on the text view
		TextView textView = findViewById(R.id.detail_text_view);
		textView.setText(getString(R.string.mountain_whitewater_descents_detailed_desc_card_text));
	}
	...
	public void showOnMap(View view) {
		...
		Uri location = Uri
				.parse("geo:0,0?q=40.6251781,-105.1027507(Mountain+Whitewater+Descents)");
