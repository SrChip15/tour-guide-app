...
public class StarOfIndiaActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		detailImageView.setImageResource(R.drawable.star_of_india);

		// grab a handle on the text view
		TextView textView = findViewById(R.id.detail_text_view);
		textView.setText(getString(R.string.star_of_india_detailed_desc_card_text));
	}
