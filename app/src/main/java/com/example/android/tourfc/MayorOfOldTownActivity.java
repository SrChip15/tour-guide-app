...
public class MayorOfOldTownActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		detailImageView.setImageResource(R.drawable.mayor_old_town);

		// grab a handle on the text view
		TextView textView = findViewById(R.id.detail_text_view);
		textView.setText(getString(R.string.mayor_of_old_town_detailed_desc_card_text));
	}
	...
	public void showOnMap(View view) {
		...
		Uri location = Uri
				.parse("geo:0,0?q=40.5789011,-105.0808697(The+Mayor+of+Old+Town)");
