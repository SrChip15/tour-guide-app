...
public class HorsetoothReservoirActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		detailImageView.setImageResource(R.drawable.horsetooth_reservoir);

		// grab a handle on the text view
		TextView textView = (TextView) findViewById(R.id.attraction_detail_text_view);
		textView.setText(getString(R.string.horsetooth_reservoir_detailed_desc_card_text));
		...
		buttonView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Uri location = Uri
						.parse("geo:0,0?q=40.5527509,-105.2308442(Horsetooth+Reservoir)");
