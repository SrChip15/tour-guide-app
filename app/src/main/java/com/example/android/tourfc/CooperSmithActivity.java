...
public class CooperSmithActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		detailImageView.setImageResource(R.drawable.coopersmith_brewing);

		// grab a handle on the text view
		TextView textView = findViewById(R.id.attraction_detail_text_view);
		textView.setText(getString(R.string.coopersmith_detailed_desc_card_text));
	}
	...
	public void showOnMap(View view) {
		...
		Uri location = Uri
				.parse("geo:0,0?q=" + Uri.encode("Coopersmith\'s Pub & Brewing"));
