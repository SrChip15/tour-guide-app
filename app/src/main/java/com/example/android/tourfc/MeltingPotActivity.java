...
public class MeltingPotActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		detailImageView.setImageResource(R.drawable.the_melting_pot);

		// grab a handle on the text view
		TextView textView = (TextView) findViewById(R.id.attraction_detail_text_view);
		textView.setText(getString(R.string.the_melting_pot_detailed_desc_card_text));
	}
	...
	public void showOnMap(View view) {
		...
		Uri location = Uri
				.parse("geo:0,0?q=40.5872231,-105.0753147(The+Melting+Pot)");
