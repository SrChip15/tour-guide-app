...
class AttractionCollectionAdapter
        extends RecyclerView.Adapter<AttractionCollectionAdapter.SectionViewHolder> {
     ...
     */
    AttractionCollectionAdapter(Context context, ArrayList<AttractionCollection> dataset) {
